...
void Renderer::PreRender()
{
	...
	glm::mat4 projection = m_camera.GetProjectionMatrix((float) m_window.GetWidth() / (float) m_window.GetHeight());
...
void Renderer::RenderEntities(entt::registry& registry)
{
	...
	auto view = registry.view<Engine::Components::EntityMetadata,
